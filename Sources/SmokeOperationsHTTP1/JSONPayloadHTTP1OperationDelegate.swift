...
public struct JSONPayloadHTTP1OperationDelegate: HTTP1OperationDelegate {
    ...
    public func handleResponseForOperation<OutputType>(
            ...
            invocationContext: SmokeInvocationContext) where OutputType: OperationHTTP1OutputProtocol {
    ...
    public func handleResponseForOperation<OutputType>(
            ...
            output: OutputType,
            responseHandler: HTTP1ResponseHandler,
            invocationContext: SmokeInvocationContext) where OutputType: Encodable {
        switch location {
        case .body:
